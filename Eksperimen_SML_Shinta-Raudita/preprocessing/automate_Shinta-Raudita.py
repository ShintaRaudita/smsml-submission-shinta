...
if __name__ == "__main__":
    INPUT_FILE = "Eksperimen_SML_Shinta-Raudita/namadataset_raw/credit_card_fraud_dataset.csv"
    OUTPUT_FILE = "Eksperimen_SML_Shinta-Raudita/preprocessing/namadataset_preprocessing/credit_card_fraud_clean.csv"
